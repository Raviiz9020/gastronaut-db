...
import { UserPlus, Rocket, ChevronLeft } from 'lucide-react';
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast({
                ...
                description: "Please enter your details to complete your profile.",
            });
      ...
      <Card className="w-full max-w-md bg-card/80 backdrop-blur-sm border-purple-500/20 box-glow-accent rounded-3xl">
        ...
        <CardHeader>
          <div className="flex items-center justify-center gap-3 mb-2">
              ...
              <CardTitle className="font-headline text-4xl text-center text-purple-500">Create Account</CardTitle>
          </div>
          <CardDescription className="text-center">Join the future of dining. You will be assigned an email like username@hyperplate.app</CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex-col gap-4">
          <Button type="submit" size="lg" className="w-full text-lg border-neutral-700" variant="outline">
              <Rocket className="mr-2 h-5 w-5"/>
              Sign Up
          </Button>
           <Link href="/customer-login" passHref className="w-full">
